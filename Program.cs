...
builder
    ...
    .AddCookie(
        ...
        options =>
        {
            options.Cookie.Name = "DemosLoginCookie";
...
builder
    ...
    .AddEntityFrameworkStores<DemosDbContext>();

// allows passing datetimes without time zone data
AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true);

// allows our api endpoints to access the database through Entity Framework Core
builder.Services.AddNpgsql<DemosDbContext>(builder.Configuration["DemosDbConnectionString"]);
